...
function Navigation({ className, goHome, openHelp }) {
  return (
    <nav className={`${className} Navigation`}>
      <button onClick={goHome} type="button" className="Navigation__home">
        <img src={homeIcon} alt="Home" />
      </button>
      <button onClick={() => {}} type="button" className="Navigation__expand-queue">
        <img src={expandMoreIcon || expandLessIcon} alt="Expand" />
      </button>
      <button onClick={openHelp} type="button" className="Navigation__help">
